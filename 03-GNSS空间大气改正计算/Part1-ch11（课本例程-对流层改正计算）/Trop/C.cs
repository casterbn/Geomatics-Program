...
namespace Trop
{
    public class C
    {
        ...
        #region 2-AstronomicalFunctions
        //--------------Astronomical-----------------
        ...
        #region 3-Time Constants
        
        public static Time END_OF_TIME=new Time(2100,1,1);
        public static Time BEGINNING_OF_TIME = new Time(1900, 1, 1);
        //--------------Time constants-------------------------------
        ...
        public const long HALFWEEK = 302400L;
        /// Seconds per whole week.
        public const long FULLWEEK = 604800L;

        /// Seconds per day.
        public const long SEC_PER_DAY = 86400L;
        /// Days per second.
        public const double DAY_PER_SEC = 1.0 / SEC_PER_DAY;

        /// Milliseconds in a second.
        public const long MS_PER_SEC = 1000L;
        /// Seconds per millisecond.
        public const double SEC_PER_MS = 1.0 / MS_PER_SEC;

        /// Milliseconds in a day.
        public const long MS_PER_DAY = MS_PER_SEC * SEC_PER_DAY;
        /// Days per milliseconds.
        public const double DAY_PER_MS = 1.0 / MS_PER_DAY;

        #endregion

        // system-specific constants
       
        #region 4-GPS Time Constants
        // GPS -------------------------------------------
        ...
        #region 5-Galileo Time Constants
        ...
        #region 7-Beidou Time Constants
